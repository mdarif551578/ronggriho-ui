                ...
                <div className="md:col-span-1">
                    <Card>
                        ...
                        <CardContent className="flex flex-col gap-2">
                           <Button variant="ghost" className="justify-start gap-2"><User className="h-5 w-5" /> Profile Settings</Button>
                           <Button variant="ghost" className="justify-start gap-2"><ShoppingBag className="h-5 w-5" /> My Orders</Button>
